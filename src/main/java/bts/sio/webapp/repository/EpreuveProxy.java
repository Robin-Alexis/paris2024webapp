...
public class EpreuveProxy {
    ...
    /**
     * Get all epreuves
     * @return An iterable of all epreuves
     */
    ...
    public Epreuve getEpreuve(int id) {
        String baseApiUrl = props.getApiUrl();
        String getEpreuveUrl = baseApiUrl + "/epreuve/" + id;
    ...
    /**
     * Add a new epreuve
     * @param e A new sport (without an id)
    ...
    public Epreuve updateEpreuve(Epreuve e) {
        ...
        System.out.println("Updating epreuve at URL: " + updateEpreuveUrl + " with data: " + e.toString());
